...
train_data = [token for song in train_songs_transposed for token in [None]+tokenize_2(song)]
val_data = [token for song in val_songs for token in [None]+tokenize_2(song)]
